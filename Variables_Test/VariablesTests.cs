...
namespace Lesson8_Test
{
    public class VariablesTests
    {
        ...
        {
            double actual = LessonsHomeWork2.Task1(A, B);
        ...
        {
            (double divactual, double remaiactual) = LessonsHomeWork2.Task3(A, B);
        ...
        {
            double actual = LessonsHomeWork2.Task4(A, B, C);
        ...
        {
            (double Aactual, double Bactual) = LessonsHomeWork2.Task5(X1, Y1, X2, Y2);
